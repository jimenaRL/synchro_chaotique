...
int8_t a0, a1, a2, a3, a4, a5, a6, a7, a8;
...
const IPAddress ip(192, 168, 0, 99);     // IP para este dispositivo
...
void callback(OSCMessage &msg) {
  ...
  a6 = (int8_t) msg.getInt(12);
  aCos6.setFreq(msg.getInt(13));
  a7 = (int8_t) msg.getInt(14);
  aCos7.setFreq(msg.getInt(15));
  a8 = (int8_t) msg.getInt(16);
  aCos8.setFreq(msg.getInt(17));
}
