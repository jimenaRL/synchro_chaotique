...
/// main ///
void set_val(OSCMessage &msg) {
  current_val = msg.getFloat(0);
  Serial.print("Parameter `current_val` updated with value ");
...
void updateControl(){
  ...
  aCos1.setFreq((int) 100*current_val);
  aCos2.setFreq((int) 100*current_val);
}
