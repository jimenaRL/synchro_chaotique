...
const struct mgos_conf_entry mgos_config_schema_[234] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .num_desc = 233},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "sys", .num_desc = 13},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "shadow", .num_desc = 4},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "azure", .num_desc = 9},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "rpc", .num_desc = 28},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "azure", .num_desc = 0},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "watson", .num_desc = 7},
